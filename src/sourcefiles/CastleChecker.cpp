...
CastleChecker::CastleChecker(const Board &board, const Color& color)
: m_board(board), m_legalityChecker(LegalityChecker(board)), m_dangerChecker(DangerChecker(board, color)), m_color(color)
{
}
