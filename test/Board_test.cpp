...
TEST(BoardTest, CastleRightsAreLostAfterMovingRookKingside)
{
    // Arrange
    Board board;

    // Act
    board.MovePiece(Move(Square(2,1), Square(1,3)));
    board.MovePiece(Move(Square(1,1), Square(2,1)));
    board.MovePiece(Move(Square(2,8), Square(1,6)));
    board.MovePiece(Move(Square(1,8), Square(2,8)));
...
TEST(BoardTest, CastleRightsAreLostAfterMovingRookQueenside)
{
    // Arrange
    Board board;

    // Act
    board.MovePiece(Move(Square(7,1), Square(8,3)));
    board.MovePiece(Move(Square(8,1), Square(7,1)));
    board.MovePiece(Move(Square(7,8), Square(8,6)));
    board.MovePiece(Move(Square(8,8), Square(7,8)));
...
TEST(BoardTest, BoardIsNotSameDifferentEnPessantSquare)
{
    // Arrange
    Board board1;
    board1.MovePiece(Move(Square(2,1), Square(3,3)));
    board1.MovePiece(Move(Square(5,7), Square(5,6)));
    board1.MovePiece(Move(Square(3,3), Square(2,1)));
    board1.MovePiece(Move(Square(5,6), Square(5,5)));
    board1.MovePiece(Move(Square(5,2), Square(5,4)));
    board1.MovePiece(Move(Square(4,7), Square(4,6)));
    board1.MovePiece(Move(Square(4,2), Square(4,4)));
    board1.MovePiece(Move(Square(4,6), Square(4,5)));
    
    Board board2;
    board2.MovePiece(Move(Square(5,2), Square(5,4)));
    board2.MovePiece(Move(Square(5,7), Square(5,5)));
    board2.MovePiece(Move(Square(4,7), Square(4,5)));
    board2.MovePiece(Move(Square(4,2), Square(4,4)));
...
TEST(BoardTest, BoardIsNotSameWhenCastleRightsAreDifferent)
{
    // Arrange
    Board board1;
    board1.MovePiece(Move(Square(5,2), Square(5,4)));
    board1.MovePiece(Move(Square(5,7), Square(5,5)));
    
    Board board2;
    board2.MovePiece(Move(Square(5,2), Square(5,4)));
    board2.MovePiece(Move(Square(5,7), Square(5,5)));
    board2.MovePiece(Move(Square(5,1), Square(5,2)));
    board2.MovePiece(Move(Square(7,8), Square(6,6)));
    board2.MovePiece(Move(Square(5,2), Square(5,1)));
    board2.MovePiece(Move(Square(6,6), Square(7,8)));
